...
// ==========================================
// Background Music (Header button: music)
// ==========================================
...
function __musicSetBtnState(isRunning) {
    ...
    if (isRunning) {
        ...
        btn.innerHTML = '<i class="fas fa-stop"></i> إيقاف الموسيقى';
    } else {
        btn.classList.remove('music-playing');
        btn.innerHTML = '<i class="fas fa-music"></i> الموسيقى';
    }
}
        ...
        if (p && typeof p.catch === 'function') {
            p.catch(() => {
                ...
                if (typeof showAlert === 'function') {
                    showAlert('اضغط زر "الموسيقى" مرة تانية لتفعيل تشغيل الصوت 🔊', 'info');
                } else {
...
// ==========================================
// تحكم متقدم في الموسيقى: ضغطه طويلة على زر الموسيقى
